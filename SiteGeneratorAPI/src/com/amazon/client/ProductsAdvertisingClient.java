...
/**
 * This class is responsible for communication with Amazon Product Advertising
 * API.
 *
...
public class ProductsAdvertisingClient {
	...
	public ItemSearchResponse find(String keywords, Optional<String> category, Optional<Integer> minPrice,
		...
		try {
			...
			ItemSearchResponse itemSearchResponse = (ItemSearchResponse) unmarshaller
	...
	private Map<String, String> constructParams(String keywords, Optional<String> category, Optional<Integer> minPrice,
			Optional<Integer> maxPrice) {
		...
		if (category.isPresent()) { // you have to specify category if you want
