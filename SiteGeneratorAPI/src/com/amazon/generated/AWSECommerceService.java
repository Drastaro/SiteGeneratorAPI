 ...
 * 
 */
@WebServiceClient(name = "AWSECommerceService", targetNamespace = "http://webservices.amazon.com/AWSECommerceService/2011-08-01", wsdlLocation = "http://webservices.amazon.com/AWSECommerceService/AWSECommerceService.wsdl?rw_useCurrentProtocol=1")
public class AWSECommerceService extends Service {

	private final static URL AWSECOMMERCESERVICE_WSDL_LOCATION;
	private final static Logger logger = Logger.getLogger(com.amazon.generated.AWSECommerceService.class.getName());

	static {
		URL url = null;
		try {
			URL baseUrl;
			baseUrl = com.amazon.generated.AWSECommerceService.class.getResource(".");
			url = new URL(baseUrl,
					"http://webservices.amazon.com/AWSECommerceService/AWSECommerceService.wsdl?rw_useCurrentProtocol=1");
		} catch (MalformedURLException e) {
			logger.warning(
					"Failed to create URL for the wsdl Location: 'http://webservices.amazon.com/AWSECommerceService/AWSECommerceService.wsdl?rw_useCurrentProtocol=1', retrying as a local file");
	...
	public AWSECommerceService() {
		super(AWSECOMMERCESERVICE_WSDL_LOCATION,
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceService"));
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePort() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePort"),
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortCA() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortCA"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortCN() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortCN"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortDE() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortDE"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortES() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortES"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortFR() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortFR"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortIN() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortIN"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortIT() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortIT"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortJP() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortJP"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortUK() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortUK"),
				AWSECommerceServicePortType.class);
	}
	...
	public AWSECommerceServicePortType getAWSECommerceServicePortUS() {
		return super.getPort(
				new QName("http://webservices.amazon.com/AWSECommerceService/2011-08-01", "AWSECommerceServicePortUS"),
				AWSECommerceServicePortType.class);
	}
